                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                    ...
                                    <tbody>
                                        ...
                                        $s = "SELECT * FROM category order by CategoryName ASC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php 
                                                echo" <td><IMG src='categoryimages/$data[3]' style='height:100PX; width:100PX;' /></td> ";
                                                ?>
                                                <td><a href="update_category.php?catid=<?php echo $data[0]; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a></td>
