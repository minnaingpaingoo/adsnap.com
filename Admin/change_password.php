...
else
{
  if(isset($_POST['submit']))
  {
    ...
    $sql ="SELECT * FROM admin WHERE AdminId='".$aid."' and Password='".$current_password."'";
    ...
    if($r > 0)
    {
        ...
        $con="update admin set Password='".$new_password."' where AdminId='".$aid."'";
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal row-fluid" method="post" enctype="multipart/form-data" onsubmit="return checkpass();" name="changepassword">
                                            <div class="control-group">
                                                ...
                                                <div class="col-6">
                                                    <input type="password" class="form-control bg-dark" id="basicinput1" name="current_password" class="span6 tip" required minlength="4" maxlength="20" placeholder="Enter Your Current Password" title="Password can contain between 4 and 20">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="control-group">
                                                ...
                                                <div class="col-6">
                                                    <input type="password" class="form-control bg-dark" id="basicinput2" name="new_password" class="span6 tip" required minlength="4" maxlength="20" placeholder="Enter Your New Password" title="Password can contain between 4 and 20">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="control-group">
                                                ...
                                                <div class="col-6">
                                                    <input type="password" class="form-control bg-dark" id="basicinput3" name="confirm_password" class="span6 tip" required minlength="4" maxlength="20" placeholder="Enter Your Confirm New Password" title="Password can contain between 4 and 20">
                                                </div>
                                            </div>
                                        <br>
