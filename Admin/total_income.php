...
<head>
    <meta charset="utf-8">
    <title>Admin - Total Income</title>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 class="h3 mb-4 text-gray-800">Total Income</h1>
                <div class="row g-4">
                    <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTableHover">
                                    ...
                                    <tbody>
                                        ...
                                        $s = "SELECT min(Date), max(Date), CategoryName, sum(Total_Income) FROM total_income GROUP BY CategoryName;";
