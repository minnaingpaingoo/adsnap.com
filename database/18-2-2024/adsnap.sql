...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2024 at 06:42 AM
...
--
ALTER TABLE `advertising`
  MODIFY `AdId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `advertising_log`
--
ALTER TABLE `advertising_log`
  MODIFY `AdLogId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
